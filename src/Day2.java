...
public class Day2 {
    ...
    public static void main(String[] args) {
        int[][] inputTest1 = {{5,1,9,5},
                            {7,5,3},
                            {2,4,6,8}};

        int[][] inputTest2 = {{5,9,2,8},
                              {9,4,7,3},
                              {3,8,6,5}};
    ...
    private static int evenDiv(int[][] matrix) {
        int result = 0;
        ...
        for (int row = 0; row < matrix.length; row++) {
            for (int col = 0; col < matrix[row].length; col++) {
                ...
                for(int i = 0; i < matrix[row].length; i++) {
                    if (one % matrix[row][i] == 0 && !hasDivided && one != matrix[row][i]) {
                        hasDivided = true;
                        result += one / matrix[row][i];
                    }
                }
            }
